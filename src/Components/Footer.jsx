    ...
    <footer className="footer">
      <div className="footer__left">
        <div className="footer__left-left">
          <div className="footer__left-left-logo">
        ...
        <div className="footer__left-middle">
          <ul className="footer__left-middle-list">
            <li>
        ...
        <div className="footer__left-right">
          <ul className="footer__left-right-list">
            <li>
